...
const image = {
  url: 'https://res.cloudinary.com/deveb1jqw/image/upload/v1732900314/Melic/Melic_music_discovery_app_1_ks1lxr.png',
  width: 1400,
  height: 10966,
  alt: 'Melic Music Discovery App - Complete Design'
}

export default function MelicMusicApp() {
        ...
        <div className="max-w-7xl mx-auto px-6">
          <ScrollAnimation>
            <div className="text-center">
              <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-orange-500 via-amber-500 to-yellow-500 bg-clip-text text-transparent">
                Melic Music Discovery App
              </h1>
              <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto mb-4">
                Music discovery platform with personalized recommendations
              </p>
              <p className="text-lg text-gray-400 max-w-3xl mx-auto">
                Seamless playlist management and intuitive user experience
              </p>
            </div>
          </ScrollAnimation>
          ...
          <ScrollAnimation delay={0.2}>
            <div className="mt-12 flex flex-wrap justify-center gap-3">
              {['Music App', 'User Experience', 'Interactive Design', 'Figma', 'Prototyping', 'UI/UX Design'].map((tech, index) => (
                <span
                  key={index}
        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="mt-12 pt-8 border-t border-white/10">
            <p className="text-gray-500 text-sm">
              © 2025 Melic Music App. Crafted with passion for exceptional user experiences.
            </p>
          </div>
        </div>
      </footer>
